...
class OrderPage(BasePage):
    ...
    def filling_first_form(self):
        self.send_keys_to_input(OrderPageLocators.name, 'Иван')
        self.send_keys_to_input(OrderPageLocators.last_name, 'Иванов')
        self.send_keys_to_input(OrderPageLocators.address, 'Москва')
        self.send_keys_to_input(OrderPageLocators.metro, 'Черкизовская')
        self.click_on_element(OrderPageLocators.station_metro)
        self.send_keys_to_input(OrderPageLocators.phone, '89998887766')
        self.wait_element_stay_clickable(OrderPageLocators.next_btn)
        self.click_on_element(OrderPageLocators.next_btn)

    def filling_second_form(self):
        self.wait_visibility_of_element(OrderPageLocators.make_order_btn)
        self.click_on_element(OrderPageLocators.when_deliver)
        self.send_keys_to_input(OrderPageLocators.when_deliver, '01.08.2025')
        ...
        self.send_keys_to_input(OrderPageLocators.comment, 'комментарий')
